        ...
        <div class="mx-auto max-w-7xl px-4 py-24 sm:px-6 sm:py-16 lg:px-8">
            <div class="mx-auto">
                ...
                <div class="pb-4">
                    ...
                    <fieldset class="my-8">
                        <FwbInput v-model="historyOfDiabetes"
                                  placeholder="N/A"
                    ...
                    <fieldset class="my-8">
                        <FwbInput v-model="historyOfEpilepsy"
                                  placeholder="N/A"
                    ...
                    <fieldset class="my-8">
                        <FwbInput v-model="historyOfHeartAttack"
                                  placeholder="N/A"
                    ...
                    <fieldset class="my-8">
                        <FwbInput v-model="historyOfBlackOuts"
                                  placeholder="N/A"
                    ...
                    <fieldset class="my-8">
                        <FwbInput v-model="historyOfPsychosis"
                                  placeholder="N/A"
